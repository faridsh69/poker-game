...
type TypeProps = { money: number; noCent?: boolean; showChips?: boolean; brif?: boolean; noDigits?: boolean }

export const Money = (props: TypeProps) => {
  const { money, noCent = false, showChips = false, brif = false, noDigits = false } = props
