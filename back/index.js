...
const { renderJoinTable, renderSitUser, renderQuitTable } = require('./helpers')
...
io.on('connection', socket => {
  ...
  socket.on('client_quit_table', ({ tableId, username }) => {
    socket.leave(tableId)
    tablesState = renderQuitTable(tablesState, tableId, username)
    io.emit('server_tables', { tables: tablesState })
  })
