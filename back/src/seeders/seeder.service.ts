...
export class SeederService {
  constructor(
    ...
    private readonly tablesService: TablesService, // private readonly paymentsService: PaymentsService, // private readonly transactionsService: TransactionsService,
  ) {
